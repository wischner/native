//
// Implements the Haiku control-paint backend.
//
...
namespace detail
{
    ...
    control_paint::palette control_paint_backend_palette() {
        ...
        p.button_bg = rgba(240, 240, 240, 255);
        p.button_border = rgba(128, 128, 128, 255);
        p.button_text = rgba(0, 0, 0, 255);
        p.button_hot_bg = rgba(225, 235, 250, 255);
        p.button_hot_text = rgba(0, 0, 0, 255);
        p.button_pressed_bg = rgba(200, 220, 245, 255);
        p.button_pressed_text = rgba(0, 0, 0, 255);

        p.menu_bar_bg = rgba(240, 240, 240, 255);
        p.menu_bar_line_top = rgba(255, 255, 255, 255);
        p.menu_bar_line_bottom = rgba(128, 128, 128, 255);
        p.menu_text = rgba(0, 0, 0, 255);
        p.menu_hot_bg = rgba(0, 120, 215, 255);
        p.menu_hot_text = rgba(255, 255, 255, 255);
        p.menu_popup_bg = rgba(255, 255, 255, 255);
        p.menu_popup_border = rgba(128, 128, 128, 255);
        return p;
    }
