//
// Implements X11 CLIPBOARD selection ownership and snapshots for Motif
// UTF-8 text and PNG image representations.
//
...
namespace
{
    ...
    selection_result request(Widget widget, Atom target) {
        ...
        while (result.pending) {
            XtAppProcessEvent(
                linux::openmotif::app_instance, XtIMAll);
        }
        return result;
    }
} // namespace
