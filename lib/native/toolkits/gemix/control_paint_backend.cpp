//
// Implements the GEMix control-paint backend.
//
...
namespace detail
{
    ...
    control_paint::palette control_paint_backend_palette() {
        ...
        p.button_bg = rgba(255, 255, 255, 255);
        p.button_border = rgba(0, 0, 0, 255);
        p.button_text = rgba(0, 0, 0, 255);
        p.button_hot_bg = rgba(220, 220, 220, 255);
        p.button_hot_text = rgba(0, 0, 0, 255);
        p.button_pressed_bg = rgba(0, 0, 0, 255);
        p.button_pressed_text = rgba(255, 255, 255, 255);

        p.menu_bar_bg = rgba(255, 255, 255, 255);
        p.menu_bar_line_top = rgba(0, 0, 0, 255);
        p.menu_bar_line_bottom = rgba(0, 0, 0, 255);
        p.menu_text = rgba(0, 0, 0, 255);
        p.menu_hot_bg = rgba(0, 0, 0, 255);
    ...
    bool control_paint_backend_draw_button_face_native(
        gpx &, const rect &, const control_paint::state &) {
        return false;
    }
    ...
    bool control_paint_backend_draw_button_text_native(
        gpx &, const rect &, const std::string &, const control_paint::state &) {
        return false;
    }

    bool control_paint_backend_draw_menu_bar_background_native(gpx &, const rect &) {
        return false;
    }
