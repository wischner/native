//
// Implements the X11 control-paint backend.
//
...
namespace detail
{
    ...
    control_paint::palette control_paint_backend_palette() {
        ...
        p.button_hot_bg = rgba(0, 0, 0, 255);
        p.button_hot_text = rgba(255, 255, 255, 255);
    ...
    int control_paint_backend_text_y_centered(const rect &r) {
        // X11 core fonts are drawn by baseline, not top-left.
