//
// Implements OPEN LOOK image drawing with the shared software
// rasterizer and Xlib stock-font rendering.
//
...
namespace native
{
    ...
    gpx &gpx_img::draw_native_text(
        ...
        XSetClipRectangles(
            display, gc, 0, 0, &native_clip, 1, Unsorted);
        XDrawString(display,
                    pixmap,
                    gc,
                    position.x,
